...
const FeatureSection = () => {
  return (
    <div className="flex w-full  gap-4 ">
      <div className="relative mx-auto flex max-w-2xl items-start justify-between gap-8 rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-neutral-900">
        <div className="absolute bottom-0 right-4 z-0 size-32">
          <DotLottieReact
