...
const ContentSection = ({ content }) => {
  return (
    <div className="relative overflow-hidden bg-white py-16 text-black">
      <div className="hidden lg:absolute lg:inset-y-0 lg:block lg:size-full">
        <div
        ...
        >
          ...
          <svg
            className="absolute right-full top-1/2 -translate-x-32 -translate-y-1/2"
            width={404}
            height={384}
            fill="none"
            viewBox="0 0 404 384"
