...
<CaptionedImage caption="Upon successful permission access, let her bring her organizy shopping list to the Walmart app. Scan and go compares her list with the catalogue, and retrieves entries with no conflict. n case of Items with conflict, she can chose which item to go about" alt="iphone mockups" />
