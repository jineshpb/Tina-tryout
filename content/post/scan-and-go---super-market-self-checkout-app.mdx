...
<PullQuote quote="Carrying an additional scanning device when the user have a powerful computer in their pockets Storing and maintaining the scanners in the store" author="Issac Newton" />
